...
urlpatterns = [
    ...
    path('order/edit/<int:pk>', views.EditOrderView.as_view(),
         name='edit_order'),
    path('order/edititem/<int:pk>', views.EditOrderItemView.as_view(),
         name='edit_order_item'),
    path('order/additem/<int:orderid>', views.AddOrderItemView.as_view(),
         name='add_order_item'),
